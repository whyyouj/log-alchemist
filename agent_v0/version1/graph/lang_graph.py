...
from lang_graph_utils import start_agent, python_agent, python_agent_2, graph_agent, python_final_agent, final_agent, router, python_router
...
if __name__ == "__main__":
    ...
    image.save("../image/lang_chain_graph.png")  # You can specify your desired file name and format
